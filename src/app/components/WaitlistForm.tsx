...
export function WaitlistForm({ onSuccess }: WaitlistFormProps) {
        ...
        (window as any).grecaptcha.enterprise.ready(async () => {
          try {
            const recaptchaToken = await (window as any).grecaptcha.enterprise.execute(
              '6LcEEfErAAAAAJoE9c5PrX1uJcAGv6OZx-pY1VYY',
  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white flex items-center justify-center p-4 relative">
        <div className="bloom-overlay" />
        <Card className="w-full max-w-md p-10 glass-card backdrop-blur-xl shadow-2xl shadow-cyan-500/10 relative z-10">
  ...
  return (
    <div className="min-h-screen text-white flex items-center justify-center p-4 relative">
      {/* atmospheric bloom layer from your CSS */}
      <div className="bloom-overlay" />

      <Card className="w-full max-w-3xl glass-card backdrop-blur-xl border-slate-700/50 shadow-2xl shadow-cyan-500/10 relative z-10">
        <div className="p-8 md:p-12">
          {/* Header */}
          <div className="space-y-2 text-center mb-10">
            <h1 className='text-4xl'>Join the Waitlist</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className="bg-slate-800/70 border-slate-600 text-white placeholder:text-slate-400 focus:border-cyan-400 focus:ring-cyan-400/30"
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select name="role" required>
                      <SelectTrigger id="role" className="bg-slate-800/70 border-slate-600 text-white">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Select name="contentType" required>
                      <SelectTrigger id="contentType" className="bg-slate-800/70 border-slate-600 text-white">
                  ...
                  <div className="space-y-3">
                    ...
                    <RadioGroup name="streamingFrequency" required className="space-y-3">
                      <div className="flex items-center space-x-3 rounded-lg border border-slate-600 bg-slate-800/50 px-4 py-3 transition-colors hover:border-cyan-400/50">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select name="audienceSize" required>
                      <SelectTrigger id="audienceSize" className="bg-slate-800/70 border-slate-600 text-white">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      required
                      rows={3}
                      className="resize-none bg-slate-800/70 border-slate-600 text-white placeholder:text-slate-400 focus:border-cyan-400 focus:ring-cyan-400/30"
                    />
                  </div>
            ...
            <Button
              ...
              className="w-full btn-brand text-white font-medium py-6 rounded-lg transition-all duration-200 shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/40"
            >
