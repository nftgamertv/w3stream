...
export function WaitlistForm() {
  ...
  return (
    isClient && (    <> <div className="w-full space-y-2">
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          disabled={isLoading}
        />
        <Button type="submit" size="lg" disabled={isLoading} className="h-12 w-full bg-gradient-to-r cursor-pointer hover:text-black/80 hover:from-purple-400 hover:via-cyan-400 hover:to-green-400 from-purple-800 via-cyan-800 to-green-800 my-2 px-8 font-semibold">
          {isLoading ? (
            <>
