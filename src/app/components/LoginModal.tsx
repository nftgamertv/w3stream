  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative rounded-2xl border border-cyan-500/30 bg-gradient-to-br from-black/40 via-purple-950/20 to-black/40 backdrop-blur-xl shadow-2xl shadow-cyan-500/10">
          {/* Glow effect */}
          ...
          <div className="p-8">
            ...
            <div className="space-y-3">
              ...
              <Button
                ...
                className="w-full my-4 h-12 bg-white/10 hover:bg-white/20 border border-cyan-500/30 hover:border-cyan-400/50 text-cyan-100 font-medium rounded-xl backdrop-blur-sm transition-all duration-300 group"
              >
              ...
              <Button
                ...
                className="w-full h-12 bg-[#5865F2]/20 hover:bg-[#5865F2]/30 border border-[#5865F2]/40 hover:border-[#5865F2]/60 text-cyan-100 font-medium rounded-xl backdrop-blur-sm transition-all duration-300 group"
              >
                <svg className="w-5 h-5 mr-3 text-[#5865F2]" viewBox="0 0 24 24" fill="currentColor">
